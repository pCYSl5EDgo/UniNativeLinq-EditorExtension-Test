...
namespace UniNativeLinq.Tests
{
    ...
    public class OrderByTest
    {
        ...
        {
            new OrderByEnumerable<ThrowingEnumerable, ThrowingEnumerable.Enumerator, int, DefaultOrderByAscendingInt32>(new ThrowingEnumerable(), default, Allocator.Temp);
        }
        ...
        {
            int[] source = null;
            Assert.Throws<ArgumentNullException>(() => source.OrderBy(Comparer<int>.Default));
        }
